...
Register-ArgumentCompleter -Native -CommandName 'rwc' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'rwc' {
            ...
            [CompletionResult]::new('-L', 'L', [CompletionResultType]::ParameterName, 'Print the maximum line width (Chars)')
            [CompletionResult]::new('--longest-line', 'longest-line', [CompletionResultType]::ParameterName, 'Print the maximum line width (Chars)')
